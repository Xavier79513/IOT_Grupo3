...
public class SuperAdminActivity extends AppCompatActivity implements UserAdapter.OnUserActionListener {
    ...
    private void loadUsers() {
        ...
        userList.add(new User("1", "admin1@hotel.com", "Admin1"));
        ...
        userList.add(new User("2", "cliente1@mail.com", "Cliente1"));
        ...
        userList.add(new User("3", "taxista1@mail.com", "Taxista1"));
        ...
        userList.add(new User("4", "cliente2@mail.com", "Cliente2"));
        ...
        userList.add(new User("5", "taxista2@mail.com", "Taxista2"));
